      ...
      <div class="card-config">
        ...
        <div class="toggles">
          ...
          <ha-formfield .label=${"Show Wind Gust"}>
            <ha-switch
              .checked=${this._config.show_wind_gust!==!1}
          ...
          <ha-formfield .label=${"Show Wind Direction"}>
            <ha-switch
              .checked=${this._config.show_wind_bearing!==!1}
          ...
          <ha-formfield .label=${"Show Feels Like"}>
            <ha-switch
              .checked=${this._config.show_feels_like!==!1}
          ...
          <ha-formfield .label=${"Show Humidity"}>
            <ha-switch
              .checked=${this._config.show_humidity!==!1}
          ...
          <ha-formfield .label=${"Show Cloud Cover"}>
            <ha-switch
              .checked=${this._config.show_cloud_cover!==!1}
          ...
          <ha-formfield .label=${"Show UV Index"}>
            <ha-switch
              .checked=${this._config.show_uv_index!==!1}
        ...
        <div class="grid-container">
          ${e.map((s,r)=>f`
            <div class="column ${r<6?"divider":""}">
              ...
              ${this.config.show_wind_gust?f`<div class="detail wind">${Math.round(s.wind_gust_speed??0)} mph gusts</div>`:""}
              ${this.config.show_wind_bearing?f`<div class="detail wind-dir">${this.bearingToCardinal(s.wind_bearing)}</div>`:""}
              ${this.config.show_feels_like&&s.apparent_temperature!==void 0?f`<div class="detail feels">Feels ${Math.round(s.apparent_temperature)}${i}</div>`:""}
              ${this.config.show_humidity&&s.humidity!==void 0?f`<div class="detail humidity">${s.humidity}% humidity</div>`:""}
              ${this.config.show_cloud_cover&&s.cloud_coverage!==void 0?f`<div class="detail clouds">${s.cloud_coverage}% clouds</div>`:""}
              ${this.config.show_uv_index&&s.uv_index!==void 0?f`<div class="detail uv">UV ${s.uv_index}</div>`:""}
            </div>
          `)}
        </div>
      </ha-card>
